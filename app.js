...
questions.push(
 ...
 {type:'general',topic:'Dangerous behavior · Alcohol and drugs',icon:'🍺',q:'For a driver age 21 or older, what BAC is legally considered DUI?',a:['.02 percent','.05 percent','.08 percent','.10 percent'],correct:2,why:'A BAC of .08% or higher is DUI for drivers 21+, though impairment can support a conviction at a lower BAC.'},
 ...
 {type:'general',topic:'Penalties · Under-21 alcohol',icon:'0️⃣',q:'A Virginia driver under 21 may be convicted of illegal alcohol consumption with a BAC of:',a:['At least .02 but below .08 percent','Only .08 percent or higher','Exactly .01 percent only','At least .10 percent'],correct:0,why:'Virginia’s under-21 zero-tolerance threshold begins at .02%; .08% or higher can bring adult DUI penalties.'},
...
function resetQuiz(){ $('#quiz').classList.add('hidden');$('#results').classList.add('hidden');$('#quiz-intro').classList.remove('hidden'); }
